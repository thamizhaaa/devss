 ...
 */
     ...
     * @internal param array|null $block_functs list of methods that are block format
     */
   ...
   /**
     ...
     * @param $params
     * @return bool
     * @internal param string $resource_name
     * @internal param string $source_content
     * @internal param int $resource_timestamp
     * @internal param bool $get_source
     * @internal param bool $quiet
     */
     ...
     * @param $params
     * @return bool
     * @internal param string $resource_base_path
     * @internal param string $resource_name
     * @internal param string $resource_type
     * @internal param string $resource_name
     */
     ...
     * @internal param null|string $modifier_name
     * @internal param array|null $map_array
     */
