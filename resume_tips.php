...
<head>
    ...
    <title>Resume Tips | Staffing Spot | Job Portal</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                        <?php 
                                    $resume_query = mysql_query("select * from tbl_resume_tips where fld_delstatus = 1 Order by fld_id DESC");
                                    $count = mysql_num_rows($resume_query);
                                if($count > 0){
                                    ?>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="panel-group drop-accordion" id="accordion" role="tablist" aria-multiselectable="true">
                                 ...
                                 <?php
                                    ...
                                    $id = $resume_fetch['fld_id'];
                                    $title = $resume_fetch['fld_resume_title'];
                                    $descrip = $resume_fetch['fld_resume_description'];
                                    $status = $resume_fetch['fld_resume_status'];
                                                       ...
                                                       <div id="collapse<?php echo $id; ?>" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading<?php echo $id; ?>" aria-expanded="true">
                                                           <div class="panel-body">
                                                                  ...
                                                                  <?php if(strlen($descrip)> 250){ ?>
                                                                    <a class="pull-right rdm" href="resume_tip_details.php?id=<?php echo $id;  ?> ">Read More...</a>
                                                                    <?php } ?>
