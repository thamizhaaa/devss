...
?>
	<div>
                    ...
                    <div class="modal-body">     
                        <form role="form" class="form-horizontal" id="post_job">
                    ...
                    <input id="start" type='date' class="form-control" name="fromdate" data-date-format="YYYY-MM-DD" placeholder="Enter the post date"  readonly="readonly" value="<?php echo date($postdate); ?>">
                    ...
                    <input id="expdate" type='date' class="form-control" name="todate"  placeholder="Enter the expiry date" data-date-format="YYYY-MM-DD"  readonly="readonly" value="<?php echo date($expire_date); ?>">
                    <span class="input-group-addon" style="background-color:#FFB070;"><span class="glyphicon glyphicon-calendar"></span>
                    </span>
                </div>
                            </div>
                            ...
                            <input type="submit" class="btn btn-success" id="updatejobskill" data-id="<?php echo $viewempid ;?>" name="submit" value="Save"/>
            <input type="reset" class="btn btn-warning" value="Reset" />
            <INPUT class="btn btn-warning" Type="button" VALUE="Back" onClick="location.href = 'jobs_manage.php'">
                        </div>
                        </form>
...
//            alert(exp1);
            ...
            var ckeditor = CKEDITOR.instances['Job_details'].getData();
...
//
//
//var dataString = '&employee='+ employee +  '&manageid='+ id + '&address='+ industry + '&date='+ date+ '&job='+ job ;
////alert(dataString);
//if(employee=='' || industry=='' || date=='' || job=='' )
//{
