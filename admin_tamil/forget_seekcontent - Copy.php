...
//	  $query = mysql_query("insert into tbl_email_content(fld_header,fld_content,fld_footer,fld_processfor)values('".$subject."','".$content."','".$footer."','seek_reg')");	
	  $query = mysql_query("UPDATE `tbl_email_content` SET `fld_header`='".$subject."',`fld_content`='".$content."',`fld_footer`='".$footer."',`fld_modified_date`='". date('Y/m/d H:i:s')."' WHERE `fld_id`=5 AND `fld_processfor`='seek_forget_password'");	
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="admin_home.php"><i class="fa fa-dashboard"></i> Home</a></li> <li class="active">Email Content Management</li> <li class="active">Seeker Content</li>
                    </ol>
                </section>
...
<div class="panel-heading"><h3 class="panel-title">Job Seeker Registration Content Master</h3></div>
