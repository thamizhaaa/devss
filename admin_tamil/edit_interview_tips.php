...
//                        echo $resume_title;
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">     
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                    <textarea id="test"  name='test' class="form-control" placeholder="Enter The description" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $interview_desc; ?></textarea>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label class="col-sm-4 control-label">Interview  tips Status<span class="required">*</span></label>
                                <div class="col-sm-6">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="modal-footer">
                            <input id="updateinterview"  type="button" name="submit" class="btn btn-success"  value ="Save">  
...
//             alert resume_id;
            var title = $("#title").val();
            var ckeditor = CKEDITOR.instances['test'].getData();
...
//                           alert(result);
                     alert('interview Tips Updated Successfully');
