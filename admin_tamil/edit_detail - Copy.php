...
<!--                                <span class="err_txt help-block"><?php echo $err_employee ; ?>
                                </span></div>-->
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                   <label class="col-sm-4 control-label">No.Of Employees <span class="required">*</span></label>
                                    <div class="col-sm-6">
                                   <input id="empnum" placeholder="Enter The Contact Number" class="form-control" type="text" value="<?php echo $no_of_emp; ?>">
                                    </div>
                                </div>
                             </div>
...
<!--                                  <option value="1">Dollar($)</option>
                                ...
                                ?>
                               <?php   foreach($test_currency as $test_value_currency){?>
                                               <option  
                                                     <?php if($test_value_currency == $currency){echo("selected");}?>  
                                                         value="<?php echo $test_value_currency;?>" >
                                                             <?php 
                                                             echo $test_value_currency;?>
                                                     </option>
                               <?php   }?>
...
//                           echo $total_price;
            ...
            <INPUT class="btn btn-warning" Type="button" VALUE="Back" onClick="location.href = 'emp_manage.php'">
                          ...
                          <!--<input type='submit' class="btn btn-default pull-right" id="updatejobskill"  value ="Save Details" >--> 
