...
//	move_uploaded_file($sourcePath, $targetPath); 
	...
	?>
<script>
	alert("<?php echo " ' ".$title." ' "." "."Social Type created Successfully" ?>");
...
//    $image = $_POST['icon_img'];
    ...
    ?>
    <script>
	alert("<?php echo " ' ".$title_edit." ' "." "."Social Type Updated Successfully" ?>");
//        alert("Social Type Updated Successfully");
        window.location = "social_type.php";</script>
    <?php
	}
	
//	$sourcePath_edit = $_FILES['icon_img']['tmp_name'];
//	$targetPath_edit = "social_icons/" . $_FILES['icon_img']['name'];
			...
			<div class="col-md-12 col-sm-12 col-xs-12">     
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label class="col-sm-4 control-label">Social Type<span class="required">*</span></label>
                                <div class="col-sm-6">
                                    <input id="title" name="title" placeholder="Enter The Name" class="form-control" type="text" value="<?php echo $socialtype_name_edit; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                    <label class="col-sm-4 control-label">Upload Icon <span class="required">*</span></label>
				    <div class="edit_filediv col-sm-6">
					<input type="file" data-filename-placement="inside" onchange="edit_preview_image(this);" name="icon_img">&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    if (isset($_POST['status']) && $_POST['status']!='' && $_POST['status'] == 1) {
                                        ?> selected="selected"
                                                <?php
                                            } elseif ($socialtype_status_edit == 2) {
                                                ?> selected="selected"
                                                <?php
                                            }
                                            ?>>InActive
			    ...
			    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="modal-footer">
                            ...
                            <input type="button" onClick="location.href='social_type.php'" class="btn btn-warning" value="Back" />
                       </div> 
...
<div class="panel-body">
<form id="reset_form" class="form_top_space" method="POST" name="form_socialtype" enctype="multipart/form-data" role="form">
    <div class="form-group">
	...
	<span class="filediv">
		<input type="file" data-filename-placement="inside" onchange="preview_image(this);" name="icon_img">&nbsp;&nbsp;&nbsp;&nbsp;
		<font color="#FF0000">Only PNG,JPEG format allowed</font>
...
<?php
$pagin_query =mysql_query("select count(*) as total from tbl_social_type");
...
$social_query = mysql_query("select * from tbl_social_type limit $k,$dis");
$a=0;
...
<td>
    <a href="social_type.php?op=socialtype_edit&socialtype_id=<?php echo $socialtype_id; ?>" attr="<?php echo $socialtype_id;?>" class="edit_tdedit"><i class="btn btn-warning">EDIT</i></a>
    
<!--<a href="#" id='<?php echo $socialtype_id;?>' class="del_banner"><i class="btn btn-warning">DELETE</i></a>-->
