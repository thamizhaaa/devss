...
if (isset($_POST['submit'])) {
    ...
    $tandc = $_POST['desc'];
        ...
        $sekersel = "Select * from tbl_aboutus";
...
//                    move_uploaded_file($sourcePath, $targetPath); // Moving Uploaded file
	...
	if($image)
	{
        ...
        if ($countresume < 1) {
            ...
            $indus_query = mysql_query("insert into tbl_aboutus(fld_aboutus_image,fld_about_full_desc,fld_created_date,fld_status,fld_delstatus)values('" . $image . "','" . $tandc . "','" . $date . "','1','1')");
        } else {
           
            $indus_query = mysql_query("insert into tbl_aboutus(fld_aboutus_image,fld_about_full_desc,fld_created_date,fld_status,fld_delstatus)values('" . $image . "','" . $tandc . "','" . $date . "','2','1')");
        }
        ?>
                <script>
...
//                    move_uploaded_file($sourcePath, $targetPath); // Moving Uploaded file
	...
	if($image_edit)
	{
       ...
       if($image_edit!='')  {  
    $query_emp_details = mysql_query("Update tbl_aboutus SET fld_aboutus_image='$image_edit' where fld_id=$id");
       }else{
    ...
    ?>
    <script>
        alert("About Us edited Successfully");
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading"><h3 class="panel-title">About Us Master</h3></div>
...
if ($oper == 'edit') {
    ...
    ?>
                                <form class="form_top_space" action="" name="form_about" method="post"enctype="multipart/form-data" >

                                    <label class="col-sm-3 control-label" style="margin-left:3%;">Upload Aboutus Image *</label>
                                    <div class="col-sm-8">
					...
					<div id="img_file"></div>
					    ...
					    <input name="old_image" value="<?php echo $image; ?>" hidden/>
                                    ...
                                    <label class="col-sm-3 control-label" style="margin-left:3%;">About Us *</label>
                                    <div class="col-sm-8">
					...
					<div id="cke_desc"></div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div><input type="submit" class="btn btn-warning" id="btnUpload1" name="save"  value="Save"/>
    ...
    ?>
                                <form id="uploadimage" class="form_top_space" name="form_about" action="" method="post" enctype="multipart/form-data" >
                                    <label class="col-sm-3 control-label" style="margin-left:3%;">Upload Aboutus Image *</label>
                                    <div class="col-sm-8">
					<span class="filediv">
					...
					<div id="cke_desc"></div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div>
                                            <input type="submit" class="btn btn-warning" id="btnUpload" name="submit"  value="save"/>
                                            <input type="reset" class="btn btn-warning" value="Reset" />
...
?>
        ...
        ?>
                                            ...
                                            ?>
                                                    ...
                                                    <td><a href="about_us.php?op=edit&id=<?php echo $id; ?>" attr="<?php echo $id; ?>"><i class="btn btn-warning">Edit</i></a>
						</td>
						<td>
                                               <a href="#" id='<?php echo $id;?>' class="del_aboutus"><i class="btn btn-warning">Delete</i></a>
						</td></tr>
                                            <?php }
                                        ?>
                                    </table>
