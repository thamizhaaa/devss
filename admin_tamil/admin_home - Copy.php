...
//
//$totaljob_query = mysql_query("select * from tbl_postjob");
//$totaljob_count = mysql_num_rows($totaljob_query);
//
//$totalemployer_query = mysql_query("select * from tbl_employer");
//$totalemployer_count = mysql_num_rows($totalemployer_query);
//
//$totaljobseeker_query = mysql_query("select * from tbl_seeker_personal");
//$totaljobseeker_count = mysql_num_rows($totaljobseeker_query);
//
//
//$totalvisitor_query = mysql_query("select * from tbl_unique_visitors");
//$totalvisitor_count = mysql_num_rows($totalvisitor_query);
?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-red">
                                ...
                                <a href="data-table.php" class="small-box-footer">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
