...
//	  $query = mysql_query("insert into email_content(header,content,footer,processfor)values('".$subject."','".$content."','".$footer."','emp_reg')");	
          $query = mysql_query("UPDATE `tbl_email_content` SET `fld_header`='".$subject."',`fld_content`='".$content."',`fld_footer`='".$footer."',`fld_modified_date`='". date('Y/m/d H:i:s')."' WHERE `fld_id`=2 AND `fld_processfor`='emp_forget_password'");
		
	 if($query) {
		 
//		 header("location:admin_home.php");
		 header("location:forget_empcontent.php");
	 }
	}
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><li class="active">Employer Content</li></li><li class="active">Employer Content</li>
                    </ol>
                </section>
