...
//	  $query = mysql_query("insert into email_content(header,content,footer,processfor)values('".$subject."','".$content."','".$footer."','emp_reg')");	
          $query = mysql_query("UPDATE `tbl_email_content` SET `fld_header`='".$subject."',`fld_content`='".$content."',`fld_footer`='".$footer."',`fld_modified_date`='". date('Y/m/d H:i:s')."' WHERE `fld_id`=2 AND `fld_processfor`='emp_reg'");
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Employer Registration Content Master
                        <small>it all starts here</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="admin_home.php"><i class="fa fa-dashboard"></i> Home</a></li>                        
                        <li class="active">Employer Content</li>
                    </ol>
                </section>
