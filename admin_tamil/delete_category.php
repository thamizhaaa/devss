...
$id=$_REQUEST['id'];
$sql = "UPDATE `tbl_aboutus` SET `fld_status`=2, fld_modified_date = CURRENT_TIMESTAMP where fld_status=1";
$query = mysql_query($sql);
$sql1 = "UPDATE `tbl_aboutus` SET `fld_status`=1, fld_modified_date = CURRENT_TIMESTAMP where fld_status=2 and fld_id ='$id'";
