...
//	$sql = "SELECT fld_id,fld_usertype FROM tbl_admin WHERE fld_loginid ='$username' and fld_pass ='$password' and fld_usertype='$usertype'"; 
	 ...
	 //$match_user = $row['fld_usertype'];
	 //echo "first".$match_user;
           $count=mysql_num_rows($result);
           header("Location:admin_home.php");
           //echo "second".$count;
          
		//echo $count;
//		if(($count==1) && ($usertype == $match_user))
//		{
//			//session_register("myusername");
//			echo 'fsdfsdf'.$_SESSION['login_admin']=$username;		
//			$logadminqry = "INSERT INTO tbl_admin_lastlogin (fld_usertype,fld_last_login_date)VALUES('".$match_user."',NOW())";
...
//			
//		}
//		elseif(($count==0) || ($usertype != $match_user))
//		{	
