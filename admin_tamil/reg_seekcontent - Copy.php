...
//	  $query = mysql_query("insert into tbl_email_content(fld_header,fld_content,fld_footer,fld_processfor)values('".$subject."','".$content."','".$footer."','seek_reg')");	
	  $query = mysql_query("UPDATE `tbl_email_content` SET `fld_header`='".$subject."',`fld_content`='".$content."',`fld_footer`='".$footer."',`fld_modified_date`='". date('Y/m/d H:i:s')."' WHERE `fld_id`=1 AND `fld_processfor`='seek_reg'");	
		
	 if($query) {
		 
//		 header("location:admin_home.php");
		 header("location:reg_seekcontent.php");
	 }
	}
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Job Seeker Registration Email Content Master
                        <small>it all starts here</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="admin_home.php"><i class="fa fa-dashboard"></i> Home</a></li>                        <li class="active">Seeker Content</li>
                    </ol>
                </section>
			...
			<?php 
                        $query = mysql_query("select * from  tbl_email_content where fld_id=1");
