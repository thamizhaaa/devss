...
session_start();
if(!empty($_SESSION["linkedin_user"]))
{
	...
	$query = mysql_query("select * from seeker_personal where mailid = '".$emailAddress."'");
...
if(isset($_POST['submit'])) {
	...
	$seek_query = mysql_query("INSERT INTO seeker_personal(fid,state,fname,lname,dob,mobile,mailid,status,provider_name,country)VALUES('".$lid."','".$state."','".$fname."','".$lname."','".$dob."','".$mobile."','".$email."',1,'LinkedIn','".$country."')");
...
<tr>
<td colspan='2' style='text-align:center'>All rights reserved © 2015 <a href='http://www.staffingspot.in/'>Staffingspot Ltd.</a>  </td>
</tr>
</table>
</body>
</html>";	
...
<title>StaffingSpot | LinkedIn</title>
...
<div class="col-sm-3"><input type="text"  class="form-control" name="fname" placeholder="First Name *"  value="<?php echo $firstName; ?>"/><span class="help-block"><?php echo $err_fname; ?></span></div>

<label class="col-sm-1 control-label" style="margin-left:3%;">Last Name *</label>
<div class="col-sm-3"><input type="text"  class="form-control" name="lname" placeholder="Last Name" value="<?php echo $lastName; ?>"/><span class="help-block"><?php echo $err_lname; ?></span></div>
...
<div class="col-sm-3"><input type="text"  class="form-control" name="email" placeholder="Email ID *" value="<?php echo $emailAddress; ?>"/><span class="help-block"><?php echo $err_email; ?></span></div>


  <label class="col-sm-1 control-label" style="margin-left:3%;">Date of Birth *</label>
  <div class="col-sm-3"><input type="text"  class="form-control" id="datepicker"  name="dob" placeholder="Date of Birth *" value="<?php echo $_POST['dob']; ?>" readonly data-date-format="dd-mm-yyyy" /><span class="help-block"><?php echo $err_dob; ?></span></div>
