...
?>
   <div>
                    ...
                    <div class="modal-body">     
                        <form role="form" class="form-horizontal" id="form" class="edit_profile">
...
?>">
				    ...
				    <input type='text' class="form-control" placeholder="Enter date of birth" id="txtdob" name="txtdob"  value="<?php echo $dob; ?>">
...
<!--                            <div class="col-md-12 col-sm-12 col-xs-12">
				    ...
				    <input type='text' class="form-control" name="todate"  placeholder="End Date *" data-date-format="YYYY-MM-DD"  readonly="readonly" value="<?php echo $dob; ?>">
				    <span class="input-group-addon" style="background-color:#FFB070;"><span class="glyphicon glyphicon-calendar"></span>
				    </span>
				</div>
                            </div>
                        ...
                        <!-- <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                               <label class="col-sm-4 control-label">Date Of Birth<span class="required">*</span></label>
                                <div class="col-sm-6">
                                    <input type="text" placeholder="Enter date of birth" class="form-control" value="<?php echo $dob; ?>" id="txtdob" name="txtdob" placeholder="MM/DD/YYYY">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                               <label class="col-sm-4 control-label">Keywords<span class="required">*</span></label>
                                <div class="col-sm-6">
                                    <input type="text" placeholder="Enter the keyword" id="tags" name="tags" class="form-control" value="<?php echo $tag;?>" data-role="tagsinput">
