...
<!--  							<li><a href="master_jobtype.php"><i class="fa fa-angle-double-right"></i>Job Type Master</a></li>-->
	    ...
	    <li class="treeview <?php
		    if ($file == 'mem_priceform.php' || $file == 'booster.php' || $file == 'currency_types.php' || $var == 'mem_priceform.php' || $var == 'booster.php' ||$var == 'edit_booster.php' || $var == 'currency_types.php') {
			echo 'active';
		    }
			?>">
		...
		<ul class="treeview-menu">
			...
			?>><a href="currency_types.php"><i class="fa fa-angle-double-right"></i>Currency Types</a></li>
                    ...
                    <li <?php
		    if ($file == 'booster.php' || $var == 'booster.php' ||$var == 'edit_booster.php') {
			echo 'class= "active" ';
		    }
...
<!--                                <i class="fa fa-angle-left pull-right"></i>-->
	    ...
	    <li class="treeview <?php
			if ($file == 'resume_tips.php' || $file == 'interview_tips.php' || $file == 'terms_condition.php' || $file == 'about_us.php' || $var == 'resume_tips.php' || $var == 'edit_resume_tips.php' || $var == 'interview_tips.php' || $var == 'edit_interview_tips.php' || $var == 'terms_condition.php' || $var == 'about_us.php') {
			    echo 'active';
			}
			?>">
		<a href="#">
...
<!--		    <li><a href="resume_tips.php"><i class="fa fa-angle-double-right"></i> Resume Tips</a></li>
		    ...
		    <li <?php
			if ($file == 'resume_tips.php' || $var == 'resume_tips.php' || $var == 'edit_resume_tips.php') {
			    echo 'class= "active" ';
			}
			?>><a href="resume_tips.php"><i class="fa fa-angle-double-right"></i> Resume Tips</a></li>
		    <li <?php
			if ($file == 'interview_tips.php' || $var == 'interview_tips.php' || $var == 'edit_interview_tips.php') {
			    echo 'class= "active" ';
			}
