                ...
                <div class="col-md-12 col-sm-12 col-xs-12">     
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label class="col-sm-4 control-label">Employer Id  <span class="required">*</span></label>
                                <div class="col-sm-6">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                 <!--<textarea id="about"   class="form-control" type="text" value="<?php echo $about; ?>" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php //echo $about; ?></textarea>-->

                                    <textarea id="address" name="address" rows="5" cols="5" placeholder="Enter The Address" class="form-control" type="text" ><?php echo $address; ?></textarea>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                   ...
                                   <input id="mobile" onkeypress="javascript:return isNumber(event)" placeholder="Enter The Contact Number" class="form-control" type="text" value="<?php echo $contact; ?>">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <textarea id="about"  name="about" class="form-control" placeholder="Enter The description" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $about; ?></textarea>
                                    <!--<textarea id="about"  class="form-control" type="text" value="<?php echo $about; ?>" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php //echo $about; ?></textarea>-->
...
//    echo "SELECT tbl_package_detail.fld_pck_id,tbl_package_detail.fld_package_id,tbl_package_detail.fld_total,tbl_package_detail.fld_year,tbl_package_detail.fld_emp_id,tbl_package_price.fld_id,tbl_package_price.fld_pname,tbl_package_price.fld_pprice,tbl_package_price.fld_currency_type FROM tbl_package_detail INNER JOIN tbl_package_price ON (tbl_package_detail.fld_package_id=tbl_package_price.fld_id) WHERE tbl_package_detail.fld_emp_id =$viewempid ";
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 total_price">                                    
                                    <input  id="total_price_amount" value="<?php echo $origtotal; ?>" disabled="true" onclick="function isNumber()"> 
                                </div>
                            </div>
                        </div>
                             
                        <div class="modal-footer">
                            <input id="updatejobskill"  type="button" name="submit" class="btn btn-success"  value ="Save"> 
                            <!--<input type="reset"  id="reset" class="btn btn-warning" value="Reset" />-->
                            <input type="button" class="btn btn-warning" id="reset" value="Reset" />
...
//  $('.flexdatalist-multiples').blur(function () {
//  $('.country_allresults').blur(function () {
//      alert('hi');
//  });
            </script>
