                ...
                <section class="content">
				    ...
				    <span class="help-block err_txt"><?php echo $err_country; ?></span>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <span class="help-block-example">Ex : Indian Rupee</span>
                            ...
                            <div class="col-md-10" style="margin-top:45px;">
                                <table class="table table-striped table-bordered" align="center" width="100%" height="30px" border="1px" cellpadding="0" cellspacing="0">
