                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                ?>
                                <table id="table" class="table table-striped table-bordered" style="text-align:center" align="justify" width="100%" height="auto" border="1px" cellpadding="0" cellspacing="0">
                                    <th style="text-align:center"  width="10%">SI NO</th><th>SEEKER ID</th><th>SEEKER NAME</th><th>EMAIL ID</th><th>DATE OF REGISTRATION</th><th>STATUS</th><th>OPTION</th>
                                    <?php
...
//                                        $user_type = $fetch_array['fld_seekerid'];
    ...
    ?>"><?php echo ($array_status) ? 'Active' : 'Inactive' ?>
                                ...
                                <td class="edit_td">
                                    <a href="edit_detail_seek.php?id=<?php echo $id; ?>" id="<?php echo $id; ?>"   attr="<?php echo $id; ?>" class="edit_tdedit"><i class="btn btn-info">Edit</i></a>
                                    <a data-toggle="modal" data-target="#myModal" class="view_seeker_details" data-id="<?php echo $id; ?>" href=""><i class="btn btn-info">View</i></a>
...
<nav>
                                <ul  class="pager">
                                    ...
                                    <li class="previous"><a class="empl" id="emppage1" href="seek_manage.php?page=<?php echo ($page_cur - 1); ?>"><span aria-hidden="true">&larr;</span>Prev</a></li>
                                    <?php } else { ?>
...
//                             
                                    if ($page_cur < $total_page) {
                                        ...
                                        <li class="next"><a class="empr" id="emppage2" href="seek_manage.php?page=<?php echo ($page_cur + 1); ?>">Next<span aria-hidden="true">&rarr;</span></a></li>
                                    <?php } else { ?>
