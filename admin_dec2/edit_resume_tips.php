                ...
                <div class="col-md-12 col-sm-12 col-xs-12">     
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" id="title" name="title" placeholder="Enter The Title" class="form-control" value="<?php echo $resume_title; ?>">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                    <textarea id="test" name='test' class="ckeditor" ><?php echo $resume_desc; ?></textarea>
