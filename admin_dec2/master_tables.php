...
if (isset($_POST['submit'])) {
    ...
    if (!$validation_form1) {
        ...
        ?>
        <script>
            alert("Master Table added Successfully");
...
<!--                        <small>it all starts here</small>-->
			...
			<li class="active">Database Management</li><li class="active">Master Tables</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading"><h3 class="panel-title">Master Tables</h3></div>
                        <div class="panel-body">


			    <form class="form_split_tables" action="" method="post">
                            <div class="col-md-10" style="margin-top:45px;">
                                <table class="table table-bordered table-responsive" id="split_tables" align="center" width="100%" height="30px" border="1px" cellpadding="0" cellspacing="0">
                                   <th width="10%"><input type="button" id="selectAll" class="main" value="check/uncheck"></th>
				    <th width="10%">SI NO</th><th>TABLE NAME</th>
                                    <?php 
//                                    $pagin_query =mysql_query("select count(*) as total  from  tbl_split_tables");
...
//                                    $k=($page_cur-1)*$dis;
				    ...
				    <!--<th>OPTION</th>-->
                                    <?php
                                    $sql = mysql_query("SELECT * FROM tbl_split_tables WHERE fld_status=1");
                                    $a = 0;
						...
						<input type="checkbox" id="splittables" name="checkbox[]" value="<?php echo $industry; ?>"><br>
