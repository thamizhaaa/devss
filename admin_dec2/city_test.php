...
if(isset($_POST['submit'])) {
	...
	if(!$validation_form1) {
		...
		header('Location:city_test.php',false);	
	}
}	
?>
<!DOCTYPE html>
...
<span class="help-block-example">Ex : Chennai IN</span>
...
//  order by fld_id limit $k,$dis
  ...
  //echo $k.'robert'.$dis;
                                    ...
                                    $sql = mysql_query("select * from tbl_cities WHERE fld_status= 0");
                                    ...
                                    while ($fetch_array = mysql_fetch_array($sql)) {
                                        ...
                                        <tr id="<?php echo $id; ?>" >
                                            ...
                                            <td><a id="edit" class="editjobskill editcity" data-id="<?php echo $id; ?>" href="javascript:void(0);">Edit </a></td>
                                            <td><a  class="delete_city" data-id="<?php echo $id; ?>" href="javascript:void(0);">Delete </a></td>
                                             </tr> 
