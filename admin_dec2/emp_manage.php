                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                 <?php 
                                 //$sql_emp = mysql_query("select * from tbl_employer WHERE te.fld_delstatus!=2 order by ted.fld_id limit $k,$dis");
...
<!--                                            <td class="edit_td"><a href="#" id="<?php
                                            ...
                                            <a href="#" id="<?php
                                               ...
                                               ?>"   attr="<?php
                                               echo $id;
                                                   ?>" class="edit_trr"><i class="btn btn-danger">Delete</i></a>
...
<nav>
                                <ul  class="pager">
                                    ...
                                    <li class="previous"><a href="emp_manage.php?page=<?php echo ($page_cur - 1); ?>"><span aria-hidden="true">&larr;</span>Prev</a></li>
                                    <?php } else { ?>
...
//                             
                                    if ($page_cur < $total_page) {
                                        ...
                                        <li class="next"><a href="emp_manage.php?page=<?php echo ($page_cur + 1); ?>">Next<span aria-hidden="true">&rarr;</span></a></li>
                                    <?php } else { ?>
