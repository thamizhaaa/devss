...
<div class="panel-body">
			<div class="col-md-12 col-sm-12 col-xs-12">     
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                    <label class="col-sm-4 control-label">Upload Icon Image <span class="required">*</span></label>
				    <div class="edit_filediv col-sm-6">
					<input type="file" data-filename-placement="inside" onchange="edit_preview_image(this);" name="icon_img" accept="image/jpg,image/png,image/jpeg,image/JPEG,image/PNG,image/JPG">&nbsp;&nbsp;&nbsp;&nbsp;
...
<form id="reset_form" class="form_top_space" method="POST" name="form_socialtype" enctype="multipart/form-data" role="form">
	...
	<span class="filediv">
		<input type="file" data-filename-placement="inside" onchange="preview_image(this);" name="icon_img" accept="image/jpg,image/png,image/jpeg,image/JPEG,image/PNG,image/JPG">&nbsp;&nbsp;&nbsp;&nbsp;
		<font color="#FF0000">Only JPG,PNG,JPEG format allowed  ( Please give valid dimensions above 200 * 200 )</font>
...
<td>
    <a href="social_type.php?op=socialtype_edit&socialtype_id=<?php echo $socialtype_id; ?>" attr="<?php echo $socialtype_id;?>" class="edit_tdedit"><i class="btn btn-info">EDIT</i></a>
</td>
<td>
