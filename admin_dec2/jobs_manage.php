...
<!--                                    <th width="10%">SI NO</th><th >JOB CODE</th><th>EMPLOYER NAME</th><th>JOB TITLE</th><th>POST DATE</th><th>STATUS</th><th>DELETE</th><th>ACTION</th>-->
                                    <th width="10%">SI NO</th><th>EMPLOYER NAME</th><th>JOB TITLE</th><th>POST DATE</th><th>JOB EXPIRY DATE</th><th>STATUS</th><th>OPTION</th>
                                    <?php
    ...
    ?>"><?php echo ($array_atatus['fld_job_status']) ? 'Active' : 'Inactive' ?>
                                            ...
                                            <td class="edit_tdedit">
                                                <a href="edit_detail_job.php?id=<?php echo $id; ?>" id="<?php echo $id; ?>"   attr="<?php echo $id; ?>" class="edit_tdedit"><i class="btn btn-info">Edit</i></a>
                                                <a data-toggle="modal" data-target="#myModal" class="view_job_details" data-id="<?php echo $id; ?>" href=""><i class="btn btn-info">View</i></a>
...
<nav>
                                <ul  class="pager">
                                    ...
                                    <li class="previous"><a href="jobs_manage.php?page=<?php echo ($page_cur - 1); ?>"><span aria-hidden="true">&larr;</span>Prev</a></li>
                                    <?php } else { ?>
...
//                             
                                    if ($page_cur < $total_page) {
                                        ...
                                        <li class="next"><a href="jobs_manage.php?page=<?php echo ($page_cur + 1); ?>">Next<span aria-hidden="true">&rarr;</span></a></li>
                                    <?php } else { ?>
