...
<?php if ($total > $dis) { ?>
    ...
    <?php if ($page_cur > 1) { ?>
						...
						<li class="previous"><a class="empl" id="emppage1" href="resume_tips.php?page=<?php echo ($page_cur - 1); ?>"><span aria-hidden="true">&larr;</span>Prev</a></li>
					    <?php } else { ?>
...
//                             
						...
						?>
	                                        ...
	                                        <li class="next"><a class="empr" id="emppage2" href="resume_tips.php?page=<?php echo ($page_cur + 1); ?>">Next<span aria-hidden="true">&rarr;</span></a></li>
    <?php } else { ?>
