                ...
                <section class="content">
                    ...
                    <div class="panel panel-default">
                            ...
                            <form action="" id="form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
					    <input onkeypress="javascript:return isNumber(event)" type="text" id="price1" class="form-control" name="view_price" placeholder="View Price" value="<?php echo $edit_view; ?>" />
					    <!--<span class="err_txt help-block"><?php echo $err_price_view; ?></span>-->
                                        ...
                                        <div class="col-sm-3"><input onkeypress="javascript:return isNumber(event)" type="text" id="price2" class="form-control" name="resume_price"  placeholder="Resume Price" value="<?php echo $edit_resume; ?>"/>
					    <!--<span class="err_txt help-block"><?php echo $err_price_view; ?></span>-->
                                    </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3"><input onkeypress="javascript:return isNumber(event)" type="text" id="price3" name="postjob_price" class="form-control" placeholder="PostJob Price" value="<?php echo $edit_postjob; ?>"/>
					    <span class="err_txt help-block"><?php echo $err_price_view; ?></span></div>
