...
//	  $query = mysql_query("insert into email_content(header,content,footer,processfor)values('".$subject."','".$content."','".$footer."','emp_reg')");	
          $query = mysql_query("UPDATE `tbl_email_content` SET `fld_header`='".$subject."',`fld_content`='".$content."',`fld_footer`='".$footer."',`fld_modified_date`='". date('Y/m/d H:i:s')."' WHERE `fld_processfor`='emp_reg'");
		?><script>
            alert("Updated Successfully");
            window.location = "reg_empcontent.php";
        </script><?php
...
<!--                        <small>it all starts here</small>-->
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Employer Registration Content Master</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    ...
                    <?php 
                        $query = mysql_query("select * from  tbl_email_content where fld_id=2");
...
<div class="panel-heading"><h3 class="panel-title">Employer Registration Content Master</h3></div>
