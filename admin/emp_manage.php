...
$pagin_query = mysql_query("select count(*) as total from tbl_employer te join tbl_employer_details ted on (te.fld_id = ted.fld_empid) WHERE te.fld_delstatus!=2");
...
<!--                                        <th colspan="1">
                                    ...
                                    <!--</tr>-->
                                    <?php
                                    $sql = mysql_query("select *,ted.fld_empid as id from tbl_employer te join tbl_employer_details ted on (te.fld_id = ted.fld_empid) WHERE te.fld_delstatus!=2 order by ted.fld_id limit $k,$dis");
...
//    } else {
        ?>
                                            ...
                                            <td class="edit_tdedit">
                                                <a href="edit_detail.php?id=<?php echo $id; ?>" id="<?php echo $id; ?>"   attr="<?php echo $id;?>" class="edit_tdedit"><i class="btn btn-info seek-btn">EDIT</i></a>
                                            <a data-toggle="modal" data-target="#myModal" class="view_details" data-id="<?php echo $id; ?>" href=""><i class="btn btn-info seek-btn">VIEW</i></a>
                                            </td>
                                        </tr>
