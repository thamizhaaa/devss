...
<form class="form_top_space" action="" method="post" enctype="multipart/form-data" role="form">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="form-group">
            ...
            <textarea id="test"  name='test' class="ckeditor" placeholder="Enter The description" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
...
<a href="edit_interview_tips.php?interview_id=<?php echo $view_id; ?>" attr="<?php echo $view_id;?>" class="edit_tdedit"><i class="btn btn-info resume-btn">EDIT</i></a>

<a data-toggle="modal" data-target="#myModal" class="view_details_interview" data-id="<?php echo $view_id;?>" href=""><i class="btn btn-info resume-btn">VIEW</i></a>

<a href="#" id='<?php echo $view_id;?>' class="edit_trr_interview"><i class="btn btn-danger resume-btn dang">DELETE</i></a>
...
<?php if ($total > $dis) { ?>
                                <ul class="pagination" style="font-weight:bolder;">
                                    ...
                                    <?php if ($page_cur > 1) { ?>
                                        ...
                                        <li class="disabled" ><a href="interview_tips.php?page=<?php echo ($page_cur - 1); ?>">Prev</a></li>
                                    <?php } else { ?>
                                    ...
                                    <?php
                                        ...
                                        <?php } else { ?>
                                            <li class="disabled" ><a href="interview_tips.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                    ...
                                    if ($page_cur < $total_page) {
                                        ...
                                        <li class="disabled" ><a href="interview_tips.php?page=<?php echo ($page_cur + 1); ?>">Next >></a></li>
                                    <?php } else { ?>
