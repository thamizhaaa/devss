...
if ($oper == 'edit') {
    ...
    ?>
					...
					<span class="filediv_edit">
                                        <input type="file" data-filename-placement="inside" id="file1" onchange="preview_edit_image(this);" name="file"accept="image/jpg,image/png,image/jpeg,image/JPEG,image/PNG,image/JPG">&nbsp;&nbsp;&nbsp;&nbsp;
		<font color="#FF0000">Only JPG,PNG,JPEG format allowed  ( Please give valid dimensions above 680 * 460 )</font>
					...
					<div id="cke_desc"></div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div><input type="submit" class="btn btn-success mob-btn resume-btn mob-btn-1" id="btnUpload1" name="save"  value="Save"/>
                                            <input id='reset_edit' onclick="clearText()" type="reset" class="btn btn-warning mob-btn resume-btn mob-btn-1" value="Reset" />
                                            <input class="btn btn-warning mob-btn resume-btn mob-btn-1" Type="button" value="Back" onClick="location.href = 'about_us.php'"></div>
                                    </div>
                                </form>
    <?php
} else {
    ?>
                                <form id="form" class="form_top_space" name="form_about" action="" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="col-sm-8">
					<span class="filediv">
                                        <input type="file" data-filename-placement="inside" id="file" onchange="preview_image(this);" name="file" accept="image/jpg,image/png,image/jpeg,image/JPEG,image/PNG,image/JPG">&nbsp;&nbsp;&nbsp;&nbsp;
		<font color="#FF0000">Only JPG,PNG,JPEG format allowed  ( Please give valid dimensions above 680 * 460 )</font>
					...
					<div id="cke_desc"></div>
                                    ...
                                    <div class="col-sm-12">
                                        <label class="col-sm-3 control-label margin-let0" style="margin-left:3%;"></label>

                                        <div>
                                            <input type="submit" class="btn btn-success mob-btn resume-btn mob-btn mob-btn-1" id="btnUpload" name="submit"  value="save"/>
                                            <input type="reset" class="btn btn-warning mob-btn resume-btn mob-btn-1" onclick="clearText_create()" value="Reset" />
...
?>
			    ...
			    if (!($oper == 'edit')) {
			    ?>
                            <div class="col-md-12 staf-margin table-auto">
					...
					$a=0;
					    ...
					    $a++;
                                            ...
                                            <tr align="center"><td><?php echo $a; ?></td><td>
                                                ...
                                                </td><td class="detail" ><?php echo $desc; ?></td>
                                                <td>    <?php
                            if ($array_status == "1") {
                                ?><button class="btn btn-success pull-right resume-btn" id="<?php echo $id; ?>" value="<?php echo $id; ?>" disabled>Activated</button>

        <?php
    } else {
        ?>
                                                        <button class="btn btn-danger  activevideo pull-right resume-btn" value="<?php echo $id; ?>" >InActive</button>
                                                <?php }
                                            ?>
                                                    </td>
                                                    <td><a href="about_us.php?op=edit&id=<?php echo $id; ?>" attr="<?php echo $id; ?>"><i class="btn btn-warning resume-btn">Edit</i></a>
						</td>
						<td>
                                               <a href="#" id='<?php echo $id;?>' class="del_aboutus"><i class="btn btn-danger resume-btn">Delete</i></a>
						</td></tr>
                                            <?php }
                                        ?>
                                    </table>
    ...
    $("#reset_edit").click(function() {
        ...
        $el.wrap('<form>').closest('form').get(0).reset();
        $el.unwrap();
        $("#imgdivpreview_edit").attr("src","");
       // $('.preview').addclass('none');
        $("#imgdivpreview_edit").css("display", "none");
 ...
 function preview_image(input) {
		...
		var height = this.height;
		 if (width >= '680' && height >= '460') {
		    ...
		    $('.filediv').html('<input type="file" data-filename-placement="inside" id="file" onchange="preview_image(this);" name="file" accept="image/jpg,image/png,image/jpeg,image/JPEG,image/PNG,image/JPG"><span class="file-custom"><span id="lblError" style="color: red;"></span>');
...
//                    alert("Please give vaild dimensions above(680 * 460)");
    ...
    function preview_edit_image(input) {
		...
		}else
		{
		    ...
		    $('.filediv_edit').html('<input type="file" data-filename-placement="inside" id="file1" onchange="preview_edit_image(this);" name="file" accept="image/jpg,image/png,image/jpeg,image/JPEG,image/PNG,image/JPG"><span id="lblError1" style="color: red;"></span>');
		    var msg = "Please give vaild dimensions above(680 * 460)";
                    //alert("Please give vaild dimensions above(680 * 460)");
		    $('#lblError1').text(msg);
