...
//	  $query = mysql_query("insert into tbl_email_content(fld_header,fld_content,fld_footer,fld_processfor)values('".$subject."','".$content."','".$footer."','seek_reg')");	
	  $query = mysql_query("UPDATE `tbl_email_content` SET `fld_header`='".$subject."',`fld_content`='".$content."',`fld_footer`='".$footer."',`fld_modified_date`='". date('Y/m/d H:i:s')."' WHERE `fld_processfor`='seek_reg'");	
		?><script>
            alert("Updated Successfully");
            window.location = "reg_seekcontent.php";
        </script><?php
...
<!--                        <small>it all starts here</small>-->
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Job Seeker Registration Content Master</li>
                    </ol>
                </section>
...
<input type="reset" class="btn btn-warning mob-btn resume-btn mob-btn-1" value="Reset" />
</form>
