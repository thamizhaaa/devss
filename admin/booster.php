                ...
                <section class="content">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form method="post" class="form_top_space col-md-6 col-xs-12 col-sm-12 " action="" name='booster' enctype="multipart/form-data">
                                
                                <!--<div class="col-md-12 col-sm-12 col-xs-12">-->
                                    <div class="form-group">
                                        <label>Booster Type:<span class="required">*</span></label>
                                ...
                                <!--<div class="col-md-12 col-sm-12 col-xs-12 no-padding">-->
                                    <div class="form-group">
                                        <label class="col-xs-12">Resume View : <span class="required">*</span></label>
                                        <div class="col-sm-2 col-xs-4">
                                            
                                            <input name="view" id="num1" type="text" value="1" disabled="" class="form-control" />
                                            <input name="view_price" required id="view_price" type="hidden"/>
                                        </div>   
                                ...
                                <!--<div class="col-md-12 col-sm-12 col-xs-12 no-padding">-->
                                    <div class="form-group">
                                        <label class="col-xs-12 control-label">Resume Download : <span class="required">*</span></label>
                                        <div class="col-sm-2 col-xs-4">
                                ...
                                <!--<div class="col-md-12 col-sm-12 col-xs-12 no-padding">-->
                                    <div class="form-group">
                                        <label class="col-xs-12 control-label">Post Job : <span class="required">*</span></label>
                                        <div class="col-sm-2 col-xs-4">
						    ...
						    ?>>InActive
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="reset" class="btn btn-warning resume-btn mob-btn mob-btn-1 " name="reset"  value="Reset"/>
