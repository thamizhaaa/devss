                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <span class="err_txt help-block" id="err" style="display:none;">Please Provide your Company name </span>
                                </div>
                            </div>
                        </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="employee_id" name="employeeid" placeholder="Enter The Employee id" class="form-control" type="text" value="<?php echo $emp_id; ?>">
                                    <span class="err_txt help-block" id="err" style="display:none;">Please Provide your Id </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <span class="err_txt help-block" id="err2" style="display:none;">Enter the Address</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                   ...
                                   <span class="err_txt help-block" id="err3" style="display:none;">Enter the contact number</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <span class="err_txt help-block" id="err4" style="display:none;">No.Of Employees Must</span>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-sm-6">
                                    <select class="questions-category form-control" id="package" name="package" tabindex="-1">  
                                        ...
                                        <?php
                                            ...
                                            $packid = $row['fld_id'];
                                        ?>
                                            <option id="<?php echo $packid;?>" value="<?php echo $packprice;?>" <?php if ($packname == $package_name){ echo "selected";} ?>><?php echo $packname; ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>  
                               ...
                               <div class="col-sm-6">
                                    <select  id="currency_type" name="currency_type" >
                                        <option value="0">Select Currency</option>
                                               ...
                                               $test_currency = array(1=>'US Dollar',2=>'Indian Rupee'); 
//                                               print_r($test_currency);
                                               $currency = "SELECT * FROM tbl_package_price tpp join tbl_package_detail pd on tpp.fld_id=pd.fld_package_id where pd.fld_emp_id=$viewempid";
...
//        var pck_id = $(this).children(":selected").attr("id");
   ...
   var dataString = '&employee='+ employee + '&mail='+ mail + '&address='+ address + '&mobile='+ mobile + '&id='+ id + '&empid='+ empid + 
                    ...
                    '&total='+ total+'&currency_type='+currency_type +'&pck_id='+pck_id+'&employee_id='+employee_id;
