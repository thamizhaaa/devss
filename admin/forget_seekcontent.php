...
//	  $query = mysql_query("insert into tbl_email_content(fld_header,fld_content,fld_footer,fld_processfor)values('".$subject."','".$content."','".$footer."','seek_reg')");	
	  $query = mysql_query("UPDATE `tbl_email_content` SET `fld_header`='".$subject."',`fld_content`='".$content."',`fld_footer`='".$footer."',`fld_modified_date`='". date('Y/m/d H:i:s')."' WHERE `fld_processfor`='seek_forget_password'");	
		?><script>
            alert("Updated Successfully");
            window.location = "forget_seekcontent.php";
        </script><?php
...
<!--                        <small>it all starts here</small>-->
                    ...
                    <ol class="breadcrumb">
                        <li><a href="admin_home.php"><i class="fa fa-dashboard"></i> Home</a></li> <li class="active">Email Content Management</li><li class="active">Job Seeker Forgot Password  Content Master</li>
                    </ol>
                </section>
			...
			<?php 
                        $query = mysql_query("select * from  tbl_email_content where fld_id=5");
...
<div class="panel-heading"><h3 class="panel-title">Job Seeker Forgot Password  Content Master</h3></div>
...
<!--  <div class="form-group">
    <label >Activation Code : XXXXXXXXXXXXXXXXXXX</label>
  </div>-->
<div class="form-group">
    <label >Footer *</label>
...
<input type="submit" name="submit" class="btn btn-success mob-btn resume-btn mob-btn-1"  value="Save"/>
<input type="reset" class="btn btn-warning mob-btn resume-btn mob-btn-1" id="reset" value="Reset" />
</form>
