			...
			<div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">     
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <textarea id="descrip_edit"  name='descrip' class="ckeditor" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $description; ?></textarea>
				    ...
				    <div class="edit_filediv">
                                        <input type="file" id='file_edit' class="btn-brose" data-filename-placement="inside" onchange="edit_preview_image(this);" name="banner_img" accept="image/jpg,image/png,image/jpeg,image/JPEG,image/PNG,image/JPG">&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
			    ...
			    <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">    
                            ...
                            <input type="reset" id="reset_edit" onclick="clearText_edit()" class="btn btn-warning resume-btn mob-btn mob-btn-1" value="Reset" />
                            <!--<input type="reset" value="New" id="btnReset">-->
                            
                            <input class="btn btn-warning resume-btn mob-btn mob-btn-1" Type="button" VALUE="Back" onClick="location.href = 'master_banner.php'">
                    </div>    
...
<div class="panel-body">
<form class="form_top_space col-lg-6 col-md-8 col-sm-12 col-xs-12" id="reset_form" method="POST" name="form_banner" enctype="multipart/form-data" role="form">
    <div class="form-group">
	<label >Banner Title <span class="required">*</span></label>
  ...
  <input type="button" onclick="clearText()" class="btn btn-warning resume-btn mob-btn mob-btn-1" id="btn_front" value="Reset" />
...
<td>
<a href="master_banner.php?op=banner_edit&banner_id=<?php echo $banner_id; ?>" attr="<?php echo $banner_id;?>" class="edit_tdedit"><i class="btn btn-warning resume-btn mob-btn mob-btn-1">Edit</i></a>
</td>
<td>
<a href="#" id='<?php echo $banner_id;?>' class="del_banner"><i class="btn btn-warning resume-btn mob-btn mob-btn-1">Delete</i></a>
    ...
    <?php if ($total > $dis) { ?>
                                <ul class="pagination" style="font-weight:bolder;">
                                    ...
                                    <?php if ($page_cur > 1) { ?>
                                        ...
                                        <li class="disabled" ><a href="master_banner.php?page=<?php echo ($page_cur - 1); ?>">Prev</a></li>
                                    <?php } else { ?>
                                    ...
                                    <?php
                                        ...
                                        <?php } else { ?>
                                            <li class="disabled" ><a href="master_banner.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                    ...
                                    if ($page_cur < $total_page) {
                                        ...
                                        <li class="disabled" ><a href="master_banner.php?page=<?php echo ($page_cur + 1); ?>">Next >></a></li>
                                    <?php } else { ?>
