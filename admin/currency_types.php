...
if (isset($_POST['submit'])) {
    ...
    $e_query = mysql_query("select fld_id from tbl_currency_type where fld_currency_name='$currency' and fld_country='$country'");

    $e_sq = mysql_num_rows($e_query);


    if ($currency == "") {
	$err_currency = "This field is required";
    } else if (!$e_sq == '') {
    ...
    $errors .= $err_country . $err_currency;
	...
	$indus_query = mysql_query("INSERT INTO tbl_currency_type(fld_currency_name,fld_country)VALUES('" . $currency . "','" . $country . "')");
...
//	header('Location:currency_types.php', false);
	if($indus_query){ ?>
		...
		window.location = 'currency_types.php';
	    </script>
<?php	}
    }
}
                ...
                <section class="content">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form class="form_top_space col-md-6 col-sm-12 col-xs-12 no-padding" action="" method="post">
                                <div class="col-sm-12">
                                ...
                                <label>Currency Name *</label>
                                    ...
                                    <input type="text"  class="form-control contry" name="currency" placeholder="Currency"  value="<?php echo $currency; ?>"/>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <table class="table table-bordered" align="center" width="100%" height="30px" border="1px" cellpadding="0" cellspacing="0">
                                    <th width="10%">SI NO</th><th>CURRENCY NAME</th><th>OPTION</th>
                                    <?php
                                    $pagin_query = mysql_query("select count(*) as total  from  tbl_currency_type where fld_currency_delstatus!=2");
                                    ...
                                    $sql = mysql_query("select * from tbl_currency_type WHERE fld_currency_delstatus!= 2 order by fld_id limit $k,$dis");
  ...
  $(document).ready(function ()
  {
      $(function () {
          $(".edit_trr").click(function () {
		      ...
		      window.location.href = "currency_types.php";
                  }
              });
