               ...
               <li class="profile-pic hoverTrigger">                   
                        <?php
                         if(file_exists($empprofilepic))
                         {
                            //echo $empprofilepic;
                         ?>
                        <a href="javascript:void(0)"> <img src="<?php echo $empprofilepic; ?>" alt="user-img" class="img-circle" width="36"><span class="hidden-xs hidden-sm"><?php echo $empusername;?> </span><i class="fa fa-angle-down fa-indicator"></i> <div class="mobileTriggerButton"></div></a>
                        <?php
                         }
                        else
                        {
                        ?>                        
                        <a href="javascript:void(0)"> <img src="images/nopicture.jpg" alt="user-img" class="img-circle" width="36"><span class="hidden-xs hidden-sm"><?php echo $empusername;?> </span><i class="fa fa-angle-down fa-indicator"></i> <div class="mobileTriggerButton"></div></a>
                        <?php
                        }
                        ?>
					 ...
					 <form role="form" class=" form-horizontal signupform" id="signform" name="signform" autocomplete="off">
                                ...
                                <div class="form-group">
                                    <label for="mobile" class="col-sm-2 control-label">
                                        Mobile</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Mobile" onkeypress="return isNumberKey(event)" maxlength="10" id="txtsignupmobile" name="txtsignupmobile" required="true"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="password" class="col-sm-2 control-label">
