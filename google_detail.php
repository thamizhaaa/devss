...
if(empty($mobile)) {
	...
	$seek_query = mysql_query("INSERT INTO seeker_personal(fid,state,fname,lname,dob,mobile,mailid,status,provider_name)VALUES('".$googleid."','".$state."','".$fname."','".$lname."','".$dob."','".$mobile."','".$email."',1,'Google')");
...
<title>StaffingSpot | Google</title>
...
<div class="col-sm-3"><input type="text"  class="form-control" name="states" placeholder="Location *" value="<?php echo $_POST['states']; ?>"/><span class="help-block"><?php echo $err_state; ?></span></div>
